...
def get_db_uri():
    ...
    return 'sqlite:///kaivor_vault_v3.db'
...
def ai_summarize(title):
    ...
    try:
        ...
        res = requests.post(url, json={"contents": [{"parts":[{"text": f"Explain in 15 words: {title}"}]}]}, timeout=8).json()
        return res['candidates'][0]['content']['parts'][0]['text']
    except: return "AI Intel Busy."
...
def brief():
    ...
    return jsonify({"summary": ai_summarize(t)})
